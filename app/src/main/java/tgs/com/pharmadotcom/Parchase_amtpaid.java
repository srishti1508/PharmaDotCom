...
public class Parchase_amtpaid extends AppCompatActivity {
...
ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prchs_amtpaid);
        recyclerView=findViewById(R.id.sale_crdt_dtl);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(Parchase_amtpaid.this, 1);
 ...
 public void getServiceResponseData(){
     ...
     Call<PurchaseModel> call =api.detail_datapurchase("admin","1234","5");
     call.enqueue(new Callback<PurchaseModel>() {
         ...
         public void onResponse(Call<PurchaseModel> call,Response<PurchaseModel> response) {
           progressBar.setVisibility(View.GONE);
             ...
             if (status.getResponse().size()>0) {
                 tableAdapter = new TableAdapter(Parchase_amtpaid.this,status);
         ...
         public void onFailure(Call<PurchaseModel> call, Throwable t) {
             Toast.makeText(Parchase_amtpaid.this, "Somthing is wrong", Toast.LENGTH_SHORT).show();
             Parchase_amtpaid.this.onBackPressed();
         }
     });
 }
    ...
    private class TableAdapter  extends RecyclerView.Adapter<TableAdapter.MyViewHolder>{
        ...
        public TableAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,int i) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.prchs_amtpaid_dtl, parent, false);
        ...
        public void onBindViewHolder(@NonNull TableAdapter.MyViewHolder holder,int i) {
            ...
            holder.amt_rtn.setText(crdSale_model.getRet_amt());
            holder.amt_paid.setText(crdSale_model.getPaid_amt());
            holder.credit_note.setText(crdSale_model.getNote_amt());
            holder.blns_amt.setText(crdSale_model.getBal_amt());
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            TextView supp_name,crdt_amt,amt_rtn,amt_paid,credit_note,blns_amt;
            public MyViewHolder(@NonNull View itemView) {
                super(itemView);
                supp_name = itemView.findViewById(R.id.supp_name);
                crdt_amt = itemView.findViewById(R.id.crdt_amt);
                amt_rtn = itemView.findViewById(R.id.amt_rtn);
                amt_paid = itemView.findViewById(R.id.amt_paid);
                credit_note = itemView.findViewById(R.id.credit_note);
                blns_amt = itemView.findViewById(R.id.blns_amt);
            }
        }
    }
}
