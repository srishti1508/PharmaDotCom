...
public class Credit_tkn extends AppCompatActivity {
...
ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_tkn);
        recyclerView=findViewById(R.id.sale_crdt_dtl);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(Credit_tkn.this, 1);
 ...
 public void getServiceResponseData(){
     ...
     Call<SaleCraditModel> call =api.detail_data("admin","1234","4");
     call.enqueue(new Callback<SaleCraditModel>() {
         ...
         public void onResponse(Call<SaleCraditModel> call,Response<SaleCraditModel> response) {
           progressBar.setVisibility(View.GONE);
             ...
             if (status.getResponse().size()>0) {
                 tableAdapter = new TableAdapter(Credit_tkn.this,status);
         ...
         public void onFailure(Call<SaleCraditModel> call, Throwable t) {
             Toast.makeText(Credit_tkn.this, "Somthing is wrong", Toast.LENGTH_SHORT).show();
             Credit_tkn.this.onBackPressed();
         }
     });
 }
    ...
    private class TableAdapter  extends RecyclerView.Adapter<TableAdapter.MyViewHolder>{
        ...
        public TableAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,int i) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.crdt_tkn_dtl, parent, false);
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            TextView cust_name,cust_amt,amt_rtn,amt_rcvd,blns_amt;
