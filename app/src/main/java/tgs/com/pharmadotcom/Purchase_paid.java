...
public class Purchase_paid extends AppCompatActivity {
...
ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchs_paid);
        recyclerView=findViewById(R.id.sale_crdt_dtl);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(Purchase_paid.this, 1);
 ...
 public void getServiceResponseData(){
     ...
     Call<PurchaseModel> call =api.detail_datapurchase("admin","1234","4");
     call.enqueue(new Callback<PurchaseModel>() {
         ...
         public void onResponse(Call<PurchaseModel> call,Response<PurchaseModel> response) {
           progressBar.setVisibility(View.GONE);
             ...
             if (status.getResponse().size()>0) {
                 tableAdapter = new TableAdapter(Purchase_paid.this,status);
         ...
         public void onFailure(Call<PurchaseModel> call, Throwable t) {
             Toast.makeText(Purchase_paid.this, "Somthing is wrong", Toast.LENGTH_SHORT).show();
             Purchase_paid.this.onBackPressed();
         }
     });
 }
